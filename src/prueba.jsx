...
import './fonts.css';
import { LoginForm, LoginMainFooterBandItem, LoginMainFooterLinksItem, LoginPage, ListVariant } from '@patternfly/react-core';
...
href="https://www.patternfly.org/" linkComponentProps={{
...
href="https://www.patternfly.org/" linkComponentProps={{
    ...
    return (
        <LoginPage footerListVariants={ListVariant.inline} brandImgSrc={brandImg2} brandImgAlt="Reliabytics" backgroundImgSrc="./src/assets/imagenes/cropped-PRESENTACION-RELIABYTICS-15.png" loginTitle="Log in to your account" loginSubtitle="Enter your single sign-on LDAP credentials." socialMediaLoginContent={socialMediaLoginContent} socialMediaLoginAriaLabel="Log in with social media" signUpForAccountMessage={signUpForAccountMessage} forgotCredentials={forgotCredentials}>
            {loginForm}
        </LoginPage>
    );
};
